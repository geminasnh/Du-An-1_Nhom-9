        ...
        <div class="khung" id="show1">
          ...
          <div style="height:50%;">
            <ul>
              ...
              <li><a href="sanpham.html">Sản phẩm </a><button id="btn4"><i class="bi bi-chevron-right"></i></button>
              </li>
          ...
          <div>
            <p>Become a Nike Member for the best products, inspiration and stories in sport. <a href="">Learn more</a>
            </p>
            <div class="nextt">
